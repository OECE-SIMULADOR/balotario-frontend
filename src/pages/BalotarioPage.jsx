...
const competencyMap = {
    ...
    'Procedimientos de Selección': 'Competencia : Procedimiento de Selección',
...
const BalotarioPage = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
           ...
           console.log("Invalidando cachés después de completar balotario...");
            // Invalida la caché del historial de resultados
            queryClient.invalidateQueries({ queryKey: ['userResultsHistory'] }); 
            // Invalida la caché del perfil de usuario, porque su 'resultsCount' ha cambiado
